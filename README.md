...
![Поблочное изменение ACLR и EVM при обучении DLA и ILA](docs/images/dpd-learning-aclr-evm.png)
...
![Спектр и ACLR при использовании ILA](docs/images/ila-spectrum-aclr.png)

**AM/AM и AM/PM.** Сравниваются характеристики усилителя PA, предыскажателя DPD и их каскада DPD+PA. Пунктиром отмечены единичная амплитудная характеристика и нулевой фазовый сдвиг.

![AM/AM и AM/PM при использовании ILA](docs/images/ila-am-am-pm.png)

**Созвездие 16-QAM.** Принятые символы RX показаны красным, эталонные символы TX обозначены синими окружностями.

![Созвездие 16-QAM при использовании ILA](docs/images/ila-constellation.png)
